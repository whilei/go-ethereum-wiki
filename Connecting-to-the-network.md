...
You can also add static nodes at runtime via the js console using [`admin.addPeer()`](https://github.com/ethereumproject/go-ethereum/wiki/JavaScript-Console#addpeer):
